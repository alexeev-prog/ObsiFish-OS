...
void kmain() {
	...
	kprint_colored("ObsiFish OS 0.13.24                                                            \n", 15);

	// Приглашение
	kprint("Welcome to ObsiFish OS\n");
	kprint("Copyright (C) alexeev-prog\nRepository: https://github.com/alexeev-prog/ObsiFish-OS\n");
...
void user_input(char *input) {
    ...
    if (strcmp(input, "END") == 0) {
        ...
        rsod_clear_screen();
        kprint_colored("ObsiFish OS 0.13.24                                                            ", 17);
