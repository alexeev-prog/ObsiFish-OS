...
; -----------------------------------------------------------------------------
; Description:
;  Загрузочный сектор ObsiFish OS
; -----------------------------------------------------------------------------
...
BOOT_DRIVE:			db 0
MSG_REAL_MODE:		db "Start::16-bit RealMode", 0 						; [Старт] 16 битный реальный режим
MSG_PROT_MODE:		db "Success::Landed in 32-bit ProtMode", 0        ; [Успех] 32 битный защищенный режим
